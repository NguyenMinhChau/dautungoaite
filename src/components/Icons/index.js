...
export const MyCoinIcon = ({ className, width = '24px', height = '24px' }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 512 512"
...
export const AccountIcon = ({ className, width = '24px', height = '24px' }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 640 512"
...
export const ChatIcon = ({ className, width = '24px', height = '24px' }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 512 512"
